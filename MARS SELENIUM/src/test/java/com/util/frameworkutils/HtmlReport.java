...
public class HtmlReport implements ReportType
{
	...
	private String getThemeCss()
	{
		String themeCss =		"\t\t <style type='text/css'> \n" +
								...
								"\t\t\t table { \n" +
									...
									"\t\t\t\t margin-right: auto; \n" +
								"\t\t\t } \n\n" +
								// changed by Animesh for Report change
								/*"\t\t\t tr.heading { \n" +
	...
	public void initializeTestLog()
	{
		...
		// Animesh change for logo in report
		String testLogHeadSection;
		testLogHeadSection = 	"<!DOCTYPE html> \n" +
								"<html> \n" +
								"\t <head> \n" +
								"\t\t<body style='background-color:white;hight=150px;border=1px'> \n"+								
								"\t\t\t\t <img src='D:\\latest 20 july\\Selenium_automation\\PIM2C\\src\\test\\resources\\Downloads\\Image\\cts_logo.png' BORDER='0' style='width:150px;hight:150px;aling:left'/> \n"+								
								"\t\t\t <img src='D:\\latest 20 july\\Selenium_automation\\PIM2C\\src\\test\\resources\\Downloads\\Image\\mars.png' alt='Logo' BORDER='0' style='width:400px;hight:150px'/> \n"+
								"\t\t\t <img src='D:\\latest 20 july\\Selenium_automation\\PIM2C\\src\\test\\resources\\Downloads\\Image\\Unilever_logo.png' alt='Logo' BORDER='0' style='width:150px;hight:150px'/> \n"+
								"\t\t </body> \n"+
									"\t\t <meta charset='UTF-8'> \n" +																		
									"\t\t <title>" +
										"RMP" +
