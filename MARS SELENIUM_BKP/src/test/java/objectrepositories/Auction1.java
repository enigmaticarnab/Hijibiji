...
//  ##### Login Page Objects #####
    ...
    public static final String FederalIdCountry_dropdown_Update="(//*[@class='x-trigger-cell'])[2]";
    ...
    public static final String LeaseCheckBox="(//*[@class='x-form-field x-form-checkbox'])[6]";
    ...
    public static final String IdNumber = "//*[text()='Id Number:']/parent::td/following-sibling::td/input";
    ...
    // License info for Dealer creation 
    ...
    public static final String  PolicyExpirationDate= "//*[@name ='insurancePolicyExpirationDate']";
    ...
    public static final String EMAIL_TXT ="(//table[@class='x-grid-table x-grid-table-resizer'])[5]/tbody/tr[2]/td[3]" ;
    public static final String FAX_TXT ="(//table[@class='x-grid-table x-grid-table-resizer'])[6]/tbody/tr[2]/td[3]";
    public static final String PHONE_TXT ="(//table[@class='x-grid-table x-grid-table-resizer'])[7]/tbody/tr[2]/td[3]";
    public static final String URL_TXT ="(//table[@class='x-grid-table x-grid-table-resizer'])[8]/tbody/tr[2]/td[3]";
    public static final String LotEdit_Button ="(//table[@class='x-grid-table x-grid-table-resizer'])[2]/tbody/tr[2]/td[1]/div/img[1]";
    public static final String Save_ADDR ="(//*[text() ='Save'])[2]";
    public static final String LicenseEdit_Button="(//table[@class='x-grid-table x-grid-table-resizer'])[5]/tbody/tr[2]/td[1]/div/img[1]";
    ...
    public static final String LicenseWindow_Edit="(//*[contains(@class,'x-grid-table x-grid-table-')])[2]//td[1]//img[1]";
    ...
    // Code for different business type 
    
    public static final String UsedCheckBox="(//*[@class='x-form-field x-form-checkbox'])[5]";
    public static final String WholesaleCheckBox="(//*[@class='x-form-field x-form-checkbox'])[7]";
    public static final String ExportCheckBox = "(//*[@class='x-form-field x-form-checkbox'])[8]";
    public static final String PartsCheckBox="(//*[@class='x-form-field x-form-checkbox'])[9]";
    public static final String SalvageCheckBox="(//*[@class='x-form-field x-form-checkbox'])[10]";
    public static final String RentalCheckBox="(//*[@class='x-form-field x-form-checkbox'])[11]";
   // Add window 
    public static final String Addwidow="//*[@class='x-panel x-layer x-panel-default-framed']//div[2]";
}
